    ...
    <div style={page}>
      ...
      <div style={centerWrap}>
        <form onSubmit={handleSubmit} style={card}>
          ...
          <h1 style={title}>Student Portal Registration</h1>
          <p style={subtitle}>Create an academic account to track fees and grades.</p>
          ...
          <div style={grid}>
            ...
            <div></div> {/* Empty spacer for layout alignment */}
